...
class AttendanceResource extends Resource
{
    ...
    public static function getModelLabel(): string { return 'سجل حضور'; }
    public static function getPluralModelLabel(): string { return 'الحضور'; }
    public static function getNavigationLabel(): string { return 'الحضور والانصراف'; }
